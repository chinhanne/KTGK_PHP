...
<div class="card shadow p-4">
    ...
    <form action="index.php?controller=sinhvien&action=edit&id=<?php echo htmlspecialchars($sinhVien->MaSV); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="Hinh" name="Hinh" placeholder="Nhập URL hình ảnh" required oninput="previewImage()">
                </div>
                <div class="mb-3 text-center">
                    <img id="preview" src="" alt="Xem trước hình ảnh" class="img-thumbnail" style="max-width: 200px; display: none;">
                </div>
...
<script>
        function previewImage() {
            var url = document.getElementById("Hinh").value;
